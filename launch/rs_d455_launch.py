...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '424,240,15', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '424,240,15', 'description': 'depth stream profile'},
